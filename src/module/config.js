...
export const ACKS = {
  ...
  proficiencyType: {
    ...
    combat: "ACKS.proficiencyType.combat",
  },
  combatTraining: {
    tiers: {
      restricted: "ACKS.combat.tier.restricted",
      narrow: "ACKS.combat.tier.narrow",
      broad: "ACKS.combat.tier.broad",
      unrestricted: "ACKS.combat.tier.unrestricted",
    },
    tierHints: {
      restricted: "ACKS.combatProficiency.restrictedHint",
      narrow: "ACKS.combatProficiency.narrowHint",
      broad: "ACKS.combatProficiency.broadHint",
      unrestricted: "ACKS.combatProficiency.unrestrictedHint",
    },
    limits: {
      restrictedWeapons: 4,
      narrowCategories: 2,
    ...
    restrictedWeapons: [
      { id: "bola", label: "ACKS.combat.weapon.bola" },
      { id: "cestus", label: "ACKS.combat.weapon.cestus" },
      { id: "club", label: "ACKS.combat.weapon.club" },
      { id: "dagger", label: "ACKS.combat.weapon.dagger" },
      { id: "dart", label: "ACKS.combat.weapon.dart" },
      { id: "net", label: "ACKS.combat.weapon.net" },
      { id: "sap", label: "ACKS.combat.weapon.sap" },
      { id: "sling", label: "ACKS.combat.weapon.sling" },
      { id: "staff", label: "ACKS.combat.weapon.staff" },
      { id: "whip", label: "ACKS.combat.weapon.whip" },
    ],
    weaponOptions: [
      { id: "bola", label: "ACKS.combat.weapon.bola" },
      { id: "cestus", label: "ACKS.combat.weapon.cestus" },
      ...
      { id: "staff", label: "ACKS.combat.weapon.staff" },
      { id: "whip", label: "ACKS.combat.weapon.whip" },
      { id: "hand-axe", label: "ACKS.combat.weapon.handAxe" },
      { id: "battle-axe", label: "ACKS.combat.weapon.battleAxe" },
      { id: "great-axe", label: "ACKS.combat.weapon.greatAxe" },
      { id: "short-sword", label: "ACKS.combat.weapon.shortSword" },
      { id: "longsword", label: "ACKS.combat.weapon.longSword" },
      { id: "two-handed-sword", label: "ACKS.combat.weapon.twoHandedSword" },
      { id: "flail-1h", label: "ACKS.combat.weapon.flailOneHanded" },
      { id: "flail-2h", label: "ACKS.combat.weapon.flailTwoHanded" },
      { id: "warhammer-1h", label: "ACKS.combat.weapon.warhammerOneHanded" },
      { id: "warhammer-2h", label: "ACKS.combat.weapon.warhammerTwoHanded" },
      { id: "morning-star", label: "ACKS.combat.weapon.morningStar" },
      { id: "war-pick", label: "ACKS.combat.weapon.warPick" },
      { id: "mace", label: "ACKS.combat.weapon.mace" },
      { id: "flail", label: "ACKS.combat.weapon.flail" },
      { id: "spear", label: "ACKS.combat.weapon.spear" },
      { id: "javelin", label: "ACKS.combat.weapon.javelin" },
      { id: "lance", label: "ACKS.combat.weapon.lance" },
      { id: "pole-arm", label: "ACKS.combat.weapon.poleArm" },
      { id: "shortbow", label: "ACKS.combat.weapon.shortbow" },
      { id: "longbow", label: "ACKS.combat.weapon.longbow" },
      { id: "composite-bow", label: "ACKS.combat.weapon.compositeBow" },
      { id: "crossbow", label: "ACKS.combat.weapon.crossbow" },
      { id: "arbalest", label: "ACKS.combat.weapon.arbalest" },
      { id: "staff-sling", label: "ACKS.combat.weapon.staffSling" },
      { id: "throwing-axe", label: "ACKS.combat.weapon.throwingAxe" },
      { id: "warhammer", label: "ACKS.combat.weapon.warhammer" },
    ],
    narrowCategories: [
      { id: "narrow-axes", label: "ACKS.combat.category.narrow.axes" },
      { id: "narrow-bows", label: "ACKS.combat.category.narrow.bows" },
      { id: "narrow-flailhammermace", label: "ACKS.combat.category.narrow.flailsHammersMaces" },
      { id: "narrow-swords", label: "ACKS.combat.category.narrow.swordsDaggers" },
      { id: "narrow-spears", label: "ACKS.combat.category.narrow.spearsPolearms" },
      { id: "narrow-exotics", label: "ACKS.combat.category.narrow.exotics" },
      { id: "narrow-combo", label: "ACKS.combat.category.narrow.combo" },
    ],
    broadCategories: [
      { id: "broad-melee-small", label: "ACKS.combat.category.broad.tinySmallMediumMelee" },
      { id: "broad-melee-large", label: "ACKS.combat.category.broad.mediumLargeMelee" },
      { id: "broad-axesflails", label: "ACKS.combat.category.broad.axesFlailsHammersMaces" },
      { id: "broad-swords", label: "ACKS.combat.category.broad.swordsDaggersSpearsPolearms" },
      { id: "broad-missile", label: "ACKS.combat.category.broad.missile" },
      { id: "broad-combo", label: "ACKS.combat.category.broad.combo" },
    ],
    styles: [
      { id: "missile", label: "ACKS.combat.style.missile" },
      { id: "single", label: "ACKS.combat.style.single" },
      { id: "dual", label: "ACKS.combat.style.dual" },
      { id: "twoHanded", label: "ACKS.combat.style.twoHanded" },
      { id: "weaponShield", label: "ACKS.combat.style.weaponShield" },
    ],
  },
  tags: {
